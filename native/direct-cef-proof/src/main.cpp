...
int main(int argc, char* argv[]) {
  ...
  const bool alpha_proof = command_line->HasSwitch("alpha-proof");
  const bool interactive = command_line->HasSwitch("interactive");
  const bool auto_input = command_line->HasSwitch("auto-input");
